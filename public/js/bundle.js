...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib25lc2VsZiIsImEiOiJja3o1a3diNGUwMnZzMm9tdWZvaXB1cXVuIn0.1HkunpKBawyXhO9w1_5b3g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/oneself/ckz5nszi1004914mi5vlcpo65',
    scrollZoom: false // center: [-118.262074, 34.190725],
    // zoom: 10,
    // interactive: false,
...
var stripe = Stripe('pk_test_51KPPXjKnQPrsQHeXaVkJjLvmttffCEzSpeYbnSOYcOeeUeObctYsElgL7p6pYPahTkX3cofJcH7OVGfx15iz7W7500b7mKh3zs');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            location.replace(session.data.session.url); // await stripe.redirectToCheckout({
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You successfuly signed up! Please sign in.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--signup').textContent = 'Creating new user..';
            email = document.getElementById('email').value;
            name = document.getElementById('name').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            _context2.next = 8;
            return (0, _signup.signup)(email, name, password, passwordConfirm);
